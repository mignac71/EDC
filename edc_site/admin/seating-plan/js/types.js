...
/** @typedef {{id:string,name:string,version:number,updatedAt:string,event:{name:string,date:string,location:string,notes:string,defaultSeats:number},tables:SeatingTable[],guests:SeatingGuest[],assignments:SeatingAssignment[],viewport:{scale:number,x:number,y:number}} SeatingPlan */

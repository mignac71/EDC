...
(function(exports){
 ...
 function createPlan(name='Untitled Seating Plan'){return {id:uid('plan'),name,version:1,updatedAt:new Date().toISOString(),event:{name,date:'',location:'',notes:'',defaultSeats:10},tables:[],guests:[],assignments:[],viewport:{scale:1,x:0,y:0,seatScale:1}}}
